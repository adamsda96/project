...
class parGen:
    ...
    def genMat(self,n):
        mat = matGen(self.dim,self.defDim,self.matFile,n)
        mat.generate()
    ...
    def generate(self):
        ...
        f.write("SOURCE_TSF\n"+ (str(5/self.defDim*self.dim)+" ") * 3 +(str(115/self.defDim*self.dim)+" ")*3 + "0 0 0 2 5e-07 100 1\n\n")
        ...
        f.write("OUT_IMAGE\nEy 200 "+ str(60/self.defDim*self.dim)+" -1 -1 ey_yz\n\n")

        f.write("OUT_IMAGE\nEy 200 -1 "+str(60/self.defDim*self.dim)+" -1 ey_xz\n\n")

        f.write("OUT_IMAGE\nEy 200 -1 -1 "+str(60/self.defDim*self.dim) +" ey_xy\n\n")

        f.write("OUT_IMAGE\nEy 200 -1 -1 "+str(80/self.defDim*self.dim)+" ey_xy_2\n\n")
